...
--------------------------------------------
После внесения изменений в новую ветку (черновик, тестовую) мы можем перенести новые даные в нашу основную ветку (чистовик, основной проект). Для этого предворительно сохраняем все изменения и вносим их в новый коммит (пункт 6, 7). Иначе Git не даст нам этого сделать. После этого выбираем ту ветку в которо 
