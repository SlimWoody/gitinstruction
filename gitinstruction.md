...
Для того что бы игнорировать определенный вид файлов на пример images.jpg или images.png и непрописывать каждое имя. Можно в файл .gitignore можно прописать расширение файла таким образом:
