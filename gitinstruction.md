...
>_Для того что бы игнорировать определенный тип файлов на пример images.jpg или images.png и непрописывать каждое имя. Можно в файл .gitignore можно прописать расширение файла таким образом:_
...
*Для создания новой ветки в репозитории в следует ввести следующую команду:
```
git branch <имя ветки>
```
* Для проверки и отображения всех созданых веток используйте команду:
```
git branch
```
