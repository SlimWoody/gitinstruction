...
## 6. Добавляем файл к отслеживанию версий и изменений.
* В терминале вводим команду:

```
git add <имя_файла>
```
* После этого можно проверить статус файла с помощью команды:

```
git status
```
## 7. Добавление коммита (версии).

Для добавления коммита (версии) в терминале следует ввести следющую команду:
```
